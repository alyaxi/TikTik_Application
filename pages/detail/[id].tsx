...
const Details = ({ postDetails }: Iprops) => {
  ...
  const [isVideoMuted, setIsMuted] = useState(false);
  ...
  const handleLike = async (like = true) => {
    if (userProfile) {
      console.log("USer profile", userProfile, like);
          ...
          {isVideoMuted ? (
            <div>
              <button
                ...
                className="text-white text-1xl lg:text-2xl m-1"
              >
                <HiVolumeOff />
              </button>
            </div>
      ...
      <div className="relative w-[1000px] md:w-[900px] lg:w-[700px]">
        <div className="lg:mt-20 mt-10">
          <div className="flex gap-3 p-2 cursor-pointer font-semibold rounded">
            <div className="ml-4 md:w-16 md:h-20 w-16 h-16">
              <Link href="/">
                <>
                  <Image
                    width={62}
          ...
          <div>
            <p className="px-10 font-lg font-semibold font-gray-600">
              {post.caption}
            </p>
